CREATE TABLE "event_admin" (
	...
	CONSTRAINT "event_admin_event_id_user_id_pk" PRIMARY KEY("event_id","user_id")
);
...
ALTER TABLE "event_admin" ADD CONSTRAINT "event_admin_event_id_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."event"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "event_admin" ADD CONSTRAINT "event_admin_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
